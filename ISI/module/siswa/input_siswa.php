...
if($_GET['act']=="input"){
	?>
          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><strong>Input Data Mahasiswa</strong></h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>NIM</label>
                                            <input class="form-control" placeholder="Nim" name="nim">
                                        </div>
                                        <div class="form-group">
                                            <label>Nama</label>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
<?php                            
                            	$sql=mysql_query("select * from mahasiswa where ids='$_GET[ids]'");
...
?>
                                ...
                                <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>NIM</label>
                                            <input class="form-control" placeholder="Nim" name="nim" value="<?php echo "$rs[nim]"; ?>" >
                                        </div>
                                        <div class="form-group">
                                            <label>Nama</label>
