          <div class="row">
                <div class="col-lg-12">
					<h3 class="page-header"><strong>Data Mahasiswa</strong></h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
<?php                            
                            	$sql=mysql_query("select * from mahasiswa where nim='$_SESSION[idu]'");
...
<input type="hidden" name="id" value="<?php echo $rs['ids'] ?>" />
                                ...
                                <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label>NIM</label>
                                            <input class="form-control"  placeholder="Nim" name="nim" value="<?php echo "$rs[im]"; ?>" >
                                        </div>
                                        <div class="form-group">
                                            <label>Nama</label>
