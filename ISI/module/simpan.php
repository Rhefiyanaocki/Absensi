...
mysql_query("INSERT INTO mahasiswa(nim,nama,jk,alamat,idk,tlp,bapak,k_bapak,ibu,k_ibu,pass) 
VALUES(
'$_POST[nim]',
'$_POST[nama]',
'$_POST[jk]',
...
$mr=md5($_POST["k_password"]);
mysql_query("UPDATE mahasiswa SET nim='$_POST[nim]',nama='$_POST[nama]',jk='$_POST[jk]', alamat='$_POST[alamat]', idk='$_POST[kelas]',
tlp='$_POST[tlp]',
bapak='$_POST[bapak]',
...
if($_GET['act']=="siswa_det"){
	$pw=md5($_POST['pass']);
if(!empty($_POST['pass'])){
mysql_query("UPDATE mahasiswa SET pass='$pw' where ids='$_POST[id]'");
echo "<script>window.alert('Data Tersimpan');
...
if($_GET['act']=="hapus"){
mysql_query("delete from mahasiswa where ids='$_GET[ids]'");
echo "<script>window.alert('Data Terhapus');
        window.location=('../media.php?module=siswa&kls=semua')</script>";
